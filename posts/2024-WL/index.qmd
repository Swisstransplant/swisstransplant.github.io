...
* Die mediane Wartezeit auf eine Niere von einer zwischen 2015 – 2024 neu gelisteten Person betrug in der Schweiz rund 3 Jahre. Für die anderen Organe waren die Wartezeiten in der Regel kürzer und liegen zwischen 0.7 und 1.6 Jahren.
...
![Kumulative Inzidenzkurven des Ereignisses Transplantation für die verschiedenen Organe A–E (mit 95 %-Konfidenzband). Die Kurven zeigen die Wahrscheinlichkeit, dass eine Person innerhalb eines bestimmten Zeitraums nach der Aufnahme auf die Warteliste transplantiert wird. Das Kreuz markiert die mediane Wartezeit bis zur Transplantation, d.h. die Wartezeit, nach der die Wahrscheinlichkeit einer Transplantation 50 % beträgt. Beobachtungszeitraum 2015 – 2024.](WAIT-CI-de.png){#fig-1 width=90%}

## 2. Mediane Wartezeit bis zur Transplantation (MTT)

Möchte man einen einzigen Kennwert für die Wartezeit, so lässt sich die mediane Wartezeit bis zur Transplantation (median time to transplantation; MTT) aus den Kurven in [Abb. @fig-1] ablesen. Sie entspricht der Wartezeit, nach der die Wahrscheinlichkeit einer Transplantation 50 % beträgt und kann als mittlere Wartezeit interpretiert werden ([Tab. @tbl-6]). Dabei handelt es sich nicht um einen einfachen Durchschnitt oder Mittelwert der Wartezeiten aller Transplantierten, sondern alle Personen – transplantierte, verstorbene, von der Liste genommene und weiterhin wartende – fliessen in die Berechnung ein. Die mediane Wartezeit ist jedoch ein Mittelwert über den gesamten Beobachtungszeitraum von 2015 – 2024. Bei vielen Organen ist heute die Wartezeit kürzer als der in [Abb. @fig-1] bzw. [Tab. @tbl-6] angegebene MTT-Wert.

|                     | Mediane Wartezeit bis zur Transplantation (MTT) in Jahren|95 %-Konfidenzintervall |
|:--------------------|---------------------------------------------------------:|:-----------------------|
|Herz                 |                                                      1.13|0.85--1.57              |
...
: Mediane Wartezeit bis zur Transplantation (MTT) und 95 %-Konfidenzintervall aller neu gelisteten Personen zwischen 2015 – 2024. Die MTT ist ein Schätzwert, der mit einer gewissen Unsicherheit behaftet ist. Das 95 %-Konfidenzintervall ist der Bereich, der bei vielen Wiederholungen der Studie den wahren Wert in 95 von 100 Fällen enthält. {#tbl-6 .striped .hover}
...
|Organ                |Differenz  |Hazard Ratio |95 %-Konfidenzintervall |p-Wert      |
|:--------------------|:----------|:------------|:-----------------------|:-----------|
...
: Temps d'attente médian jusqu'à la transplantation (MTT) et intervalle de confiance à 95 % de toutes les personnes nouvellement inscrites sur la liste entre 2015 et 2024. Le MTT est une estimation qui comporte une certaine incertitude. L'intervalle de confiance à 95 % est la zone qui, en cas de nombreuses répétitions de l'étude, contient la vraie valeur dans 95 cas sur 100. {#tbl-6_FR .striped .hover}
...
|Organe               |Différence  |Hazard Ratio |Intervalle de confiance de 95 % |Valeur p  |
|:--------------------|:----------|:------------|:-----------------------|:-----------|
...
: Le hazard ratio compare le taux de transplantation pour les inscriptions début 2024 et début 2022. L'intervalle de confiance à 95 % est la zone qui contient souvent la vraie valeur en cas de nombreuses répétitions de l'étude. De très petites valeurs de p indiquent une forte évidence que le taux de transplantation a effectivement changé. {#tbl-7_FR .striped .hover}
