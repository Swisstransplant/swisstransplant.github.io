...
subtitle: "Analysis of machine perfusion data from the LifePort Kidney Transporter."
...
EXAM (ex-vivo allograft monitoring) is a dashboard for analyzing hypothermic machine perfusion data from the [ORS LifePort Kidney Transporter](https://www.organ-recovery.com/lifeport-kidney-transporter/). EXAM is free software written in the R programming language. The EXAM source code is maintained on [GitHub](https://github.com/Swisstransplant/EXAM).
...
The link to the EXAM dashboard is <https://data.swisstransplant.org/exam-dashboard/>.
:::

![Screenshot of the Swisstransplant EXAM dashboard.](dashboard.png){width=600}
...
Please cite the following work when using EXAM or the Swisstransplant R package `swt` for LifePort machine perfusion data analysis.
:::
