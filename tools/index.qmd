...
The basic statistics software is based on three components and can be downloaded for free in the links provided below.
...
::: callout-note
In Windows 10 RStudio desktop requires administrator rights. However, it is possible to download a zip bundle from the download page, unpack the files into a folder, for example, `software`, and create a shortcut with `rstudio.exe` on the desktop or the taskbar.
:::
