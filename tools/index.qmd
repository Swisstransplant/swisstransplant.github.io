...
The package is under constant development and includes the following features:
...
The [source code is developed on GitHub](https://github.com/Swisstransplant/swt). There is a   [package manual](https://github.com/Swisstransplant/swt/blob/main/manual/swt.pdf).
